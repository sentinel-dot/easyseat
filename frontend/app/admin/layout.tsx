...
const NAV_ITEMS = [
  ...
  { href: "/admin/bookings", label: "Buchungen", icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
  { href: "/admin/calendar", label: "Kalender", icon: "M6 2v2h12V2h2v2h2a2 2 0 012 2v14a2 2 0 01-2 2H4a2 2 0 01-2-2V6a2 2 0 012-2h2V2H6zm14 6H4v12h16V8z" },
  { href: "/admin/services", label: "Leistungen", icon: "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V5a2 2 0 00-2-2M5 3v2M5 19v-4a2 2 0 012-2h6a2 2 0 012 2v4M5 19h14" },
  { href: "/admin/availability", label: "Verfügbarkeit", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
